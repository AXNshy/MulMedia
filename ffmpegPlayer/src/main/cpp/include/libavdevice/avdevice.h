...
enum AVAppToDevMessageType {
     ...
     *
     * Change mute m_state. It may be device-dependent if mute status
...
enum AVDevToAppMessageType {
    ...
    /**
     * Mute m_state change message.
     *
     * Device informs that mute m_state has changed.
     *
     * data: int: 0 for not muted m_state, non-zero for muted m_state.
     */
