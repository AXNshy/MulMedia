...
typedef struct AVFilter {
    ...
    /**
     * This field determines the m_state of the formats union.
    ...
    /**
     * The m_state of the following union is determined by formats_state.
    ...
    union {
         ...
         *
         * This callback must never be NULL if the union is in this m_state.
         *
         ...
         *
         * This list must never be NULL if the union is in this m_state.
...
struct AVFilterContext {
    ...
    int is_disabled;                ///< the enabled m_state from the last expression evaluation
 ...
 *
 * @param opaque a pointer where libavfilter will store the iteration m_state. Must
