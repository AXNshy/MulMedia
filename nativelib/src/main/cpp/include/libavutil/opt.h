 ...
 *
 * @param iter a pointer where iteration m_state is stored.
 ...
 *
 * Options o must belong to the obj. This function must not be called to check child's options m_state.
